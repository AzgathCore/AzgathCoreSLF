...
std::unique_ptr<Trinity::Ed25519> EnterEncryptedModeSigner;
}
...
{
    std::unique_ptr<Trinity::Ed25519> ed25519 = std::make_unique<Trinity::Ed25519>();
...
WorldPacket const* WorldPackets::Auth::EnterEncryptedMode::Write()
{
    ...
    Trinity::Ed25519 ed25519(*EnterEncryptedModeSigner);
