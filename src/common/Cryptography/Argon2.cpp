...
/*static*/ Optional<std::string> Trinity::Argon2::Hash(std::string const& password, BigNumber const& salt, uint32 nIterations, uint32 kibMemoryCost)
{
...
/*static*/ bool Trinity::Argon2::Verify(std::string const& password, std::string const& hash)
{
